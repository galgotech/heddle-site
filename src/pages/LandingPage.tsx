        ...
        <Section className="bg-slate-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <FeatureCard title="Human-Auditable Syntax">
                    ...
                    This makes Heddle the ideal platform for integrating and <strong>reviewing code generated by LLMs</strong>.
                </FeatureCard>
        ...
        <Section>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
                <FeatureCard title="Embedded Core Architecture">
                    Heddle orchestrates your application's logic.
                    Define imperative functions in Python, Go, Rust, or Node.js, and let Heddle workflows execute them—whether running as a standalone or scaled across a distributed environment.
                </FeatureCard>
